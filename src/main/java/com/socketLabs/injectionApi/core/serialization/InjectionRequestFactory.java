...
public class InjectionRequestFactory{
    ...
    private List<CustomHeader> populateCustomHeaders(List<com.socketLabs.injectionApi.models.CustomHeader> baseCustomHeaders) {
        if (baseCustomHeaders == null) {
            return null;
        }
        List<CustomHeader> customHeaders = new ArrayList<>();

        for (com.socketLabs.injectionApi.models.CustomHeader baseCustomHeader: baseCustomHeaders) {
            customHeaders.add(new CustomHeader(baseCustomHeader.getName(), baseCustomHeader.getValue()));
        }
        return customHeaders;
    }

    private List<Attachment> populateAttachments(List<com.socketLabs.injectionApi.models.Attachment> baseAttachments) {
        if (baseAttachments == null) {
            return null;
        }
        List<Attachment> attachments = new ArrayList<>();

        for (com.socketLabs.injectionApi.models.Attachment baseAttachment: baseAttachments) {
