...
public class Main {
    ...
    private static void DisplayTheMenu() {
        ...
        System.out.println("    9:  Basic Send With Invalid Attachment");
        System.out.println("   10:  Basic Send With Invalid From ");
        System.out.println("   11:  Basic Send With Invalid Recipients ");
        System.out.println();
        System.out.println(" Bulk Send Examples: ");
        System.out.println("   12:  Bulk Send ");
        System.out.println("   13:  Bulk Send With MergeData ");
        System.out.println("   14:  Bulk Send With Ascii Charset And MergeData ");
        System.out.println("   15:  Bulk Send From DataSource With MergeData ");
        System.out.println("   16:  Bulk Send Complex Example (Everything including the Kitchen Sink) ");
        System.out.println();
        System.out.println("-------------------------------------------------------------------------");
    }
    ...
    private static String GetExampleName(String selection) {
        ...
        switch (menuItem)
        {
            ...
            case 9: return "examples.Basic.Invalid.BasicSendWithInvalidAttachment";
            case 10: return "examples.Basic.Invalid.BasicSendWithInvalidFrom";
            case 11: return "examples.Basic.Invalid.BasicSendWithInvalidRecipients";
            case 12: return "examples.Bulk.BulkSend";
            case 13: return "examples.Bulk.BulkSendWithMergeData";
            case 14: return "examples.Bulk.BulkSendWithAsciiCharsetMergeData";
            case 15: return "examples.Bulk.BulkSendFromDataSourceWithMerge";
            case 16: return "examples.Bulk.BulkSendComplexExample";
            default:
